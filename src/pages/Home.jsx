...
function Home() {
 ...
 toast.success('Successfully Added!')
  ...
  function searchhandle(e) {
   ...
   if (value.trim() === "") {
    setSearchList([]); // clear search when input is empty
    return;
  }
    ...
    // console.log(searchList, "searchlist results")
    //  setSearchList('')
  }
  ...
  return (
    <>
      <div className='All-home'>
        ...
        <Header setShowCart={setShowCart} setShowWishlist={setShowWishlist} data={data} searchData={searchData}
        ...
        <div className='product-list' style={{ position: 'relative', width: 'auto' }}>
          <div className="container-fluid mt-4">
            <div className="row">
              {
                searchData.trim() !== "" ?(  searchList.map((product) => (
